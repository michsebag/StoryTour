...
def tag_locations_from_file(file_name):
    ...
    print("Reading book...")
    file_text = open(file_name, encoding="latin-1").read()
...
def build_geo_locations_from_list(locations):
    ...
    geo_locations_json = []
    geo = geocoders.GoogleV3(api_key='AIzaSyBImFc_KpXFs2vsNNOFptiKOQyGPXpaG_s')
